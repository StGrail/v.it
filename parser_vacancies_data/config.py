...
PROCESSING_SKILLS = [
    'sql', 'linux', 'git', 'postgresql', 'django framework', 'django', 'flask', 'css', 'html', 'bash', 'mysql', 'ооп', 'docker',
    'mongodb', 'pandas', 'numpy', 'atlassian jira', 'jira', 'kubernetes', 'http', 'tcp/ip', 'trello', 'unix', 'redis'
                    ]
...
VACANCY_TABLE_COLUMNS = r"""id, id_vacancy, key_skills, experience, salary_from, salary_to, name_vacancy, 
                        area, published, alternate_url, contains_skills"""
# Названия столбцов таблицы скиллов
SKILL_TABLE_COLUMNS = r"""
                    id, id_vacancy, sql, linux, git, postgresql, django, flask, css, 
                    html, bash, mysql, ооп, docker, mongodb, pandas, numpy, jira, kubernetes, 
                    http, tcp_ip, trello, unix, redis
                    """

...
def remove_user_id_from_vacancy_relation(user_id: int, vacanies_list: 'Queryset'):
    pass


def update_shown_vacancy_to_user(user_id: int, vacanies_list: 'Queryset'):
    '''
...
def profile_view(user_request: 'Queryset') -> 'Queryset':
    ...
    update_shown_vacancy_to_user(user_id, vacanies_list)
    ...
    return vacanies_list, recommended_vacancies
